  ...
  return (
    <div className="container section-padding">
      ...
      <div className="top-creators-box grid-2-columns">
        ...
        <div className="top-creator-item">
          <div className="creator-number">05</div>
          <div className="creator-box">
            <div className="avatar box-64">
              {" "}
              <Link href="/08-profile-page">
            ...
            <div className="creator-meta">
              ...
              <div className="creator-meta">@nickstevens</div>
            </div>
          </div>
          <div className="projects-score">
            <div className="number title">50</div>
            <div className="label">Created</div>
          </div>
          <div className="projects-previews">
            <div className="preview-box box-68">
        ...
        <div className="top-creator-item">
          <div className="creator-number">06</div>
          <div className="creator-box">
            <div className="avatar box-64">
              {" "}
              <Link href="/08-profile-page">
            ...
            <div className="creator-meta">
              ...
              <div className="creator-meta">@beardedwndr</div>
            </div>
          </div>
          <div className="projects-score">
            <div className="number title">26</div>
            <div className="label">Created</div>
          </div>
          <div className="projects-previews">
            <div className="preview-box box-68">
