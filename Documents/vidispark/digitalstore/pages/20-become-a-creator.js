      ...
      <div>
        <div className="become-creator-bc-box container-1300 section-padding-medium">
          ...
          <div className="bc-image">
            <img src="img/content/creators/become-creator-2.png" alt="" />
          </div>
        </div>
        ...
        >
          ...
          <form className="cryptoki-form" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="btn btn-normal btn-fullwidth btn-dark"
            >
              Submit for Approval
            </button>
            <div className="register-notice">
              If approved, {`you’ll`} receive a confirmation email in your inbox
              within 2-5 bussiness days.
            </div>
          </form>
        </div>
      </div>
