  ...
  return (
    <Layouts>
      <div className="primary-content-area container content-padding">
        ...
        <div className="news-feed grid-3-columns">
          ...
          <div className="news-item video-post-format">
            <a
              ...
              href="https://www.youtube.com/watch?v=Ik05cmjalXw"
            >
              <svg className="crumina-icon">
          ...
          <div className="news-item">
            ...
            <div className="news-content">
              ...
              <div className="news-title h5">
                <Link href="18-blog-post-centered">
                  <a>
                    A complete guide about how to collect artworks and what you
                    can do with them
                  </a>
                </Link>
              </div>
          ...
          <div className="news-item audio-post-format">
            ...
            <div className="news-content">
              ...
              <div className="news-title h5">
                <Link href="18-blog-post-centered">
                  <a>
                    Listen to our NFT artwork podcast! This week {`we’ll`} talk
                    about new art and supporting creators
                  </a>
                </Link>
              </div>
              <div className="news-excerpt">
          ...
          <div className="news-item no-thumb">
            <div className="news-content">
              ...
              <div className="news-excerpt">
                ...
                them out for interest. Ethereum also allows for the creation
                and...{" "}
              </div>
              <div className="read-more-link">
                <Link href="18-blog-post-centered">
        ...
        <Paggination2 queryItem={".news-item"} sortItem="6" />
      </div>
    </Layouts>
  );
};
