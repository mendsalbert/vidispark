          ...
          >
            <div className="upload-row">
              <div className="upload-column">
                ...
                <input
                  className="btn btn-wide gradient-background"
                  type="submit"
                  defaultValue="Upload Item"
                />
              </div>
              <div className="upload-column">
                <h5>Upload</h5>
                <div className="upload-container">
                  <div className="artwork-upload">
                    ...
                    <div className="upload-box">
                      ...
                      <button className="btn btn-normal btn-dark browse-btn waves-effect waves-button waves-float waves-light">
                        Browse File
                      </button>
                    </div>
                  </div>
                  <div className="uploaded-preview">
                    <span className="bold green">twitterheaders04.zip</span>
                    uploaded{" "}
...
export default ProfileUploadItem;
